...
**MVP v0.2.0** — P0/P1完成，P2核心功能已交付（discover扩展路径、HTML报告、并发执行修复与测试、crypto加密存储）。226个测试全部通过。
...
### 测试覆盖
- [x] **226个单元/集成测试全部通过**（35原有 + 8端到端 + 92工具层 + 50core补充 + 3 discover扩展 + 8 HTML报告 + 7并发 + 23 crypto）
